...
#pragma warning restore CA1720
		...
		[ValidSet(typeof(RequirementState), StringComparison = StringComparison.OrdinalIgnoreCase)]
		public string DesiredState { get; set; } = RequirementState.Present.ToString();

		[ValidSet(typeof(RequirementConflictAction), StringComparison = StringComparison.OrdinalIgnoreCase)]
