...
{
	public sealed record NxtInstallationModel : IValidatableObject
	{
		...
		public ReinstallMode ReinstallMode { get; set; } = ReinstallMode.Reinstall;

		public UpgradeMode UpgradeMode { get; set; } = UpgradeMode.Reinstall;
