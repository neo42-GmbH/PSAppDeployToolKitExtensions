...
@{
	...
	RootModule             = 'PSAppDeployToolkit.Neo42.Extensions.psm1'
	...
	GUID                   = '042bb3b2-d0a5-40b1-8fde-f15727c951b9'
	...
	Description            = 'Extensions for PSAppDeployToolkit. Includes new functionality and contains neo42 package deployment logic.'
	...
	RequiredModules        = @(
		@{ ModuleName = 'PSAppDeployToolkit'; GUID = '8c3c366b-8606-4576-9f2d-4051144f7ca2'; RequiredVersion = '4.1.8' }
	)
	...
	TypesToProcess         = @(
		'PSAppDeployToolkit.Neo42.Extensions.Types.ps1xml'
	)
